        ...
        for (int col = mat_args->start; col < mat_args->end; col += 4) {
            ...
            for (int ch = 0; ch < k;) {
                ...
                for (int qj = 0; qj < 32; qj++) {
                    ...
                    signed char w0_de_0 = (w0_int4[qj] & 0x0F) - 8;
                    signed char w0_de_16 = (w0_int4[qj] >> 4) - 8;
                    signed char w1_de_0 = (w1_int4[qj] & 0x0F) - 8;
                    signed char w1_de_16 = (w1_int4[qj] >> 4) - 8;
                    signed char w2_de_0 = (w2_int4[qj] & 0x0F) - 8;
                    signed char w2_de_16 = (w2_int4[qj] >> 4) - 8;
                    signed char w3_de_0 = (w3_int4[qj] & 0x0F) - 8;
                    signed char w3_de_16 = (w3_int4[qj] >> 4) - 8;
...
void MatmulOperator::mat_mul_multithreading_loop_unrolling(struct matmul_params *params) {
    ...
    for (int i = 0; i < num_thread; ++i) {
        ...
        threads_args[i].end = (i == num_thread - 1) ? n : (n / num_thread) * (i + 1);
